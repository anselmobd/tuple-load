...
-- trocando de OBSERVACAO3 para RESPONSAVEL

UPDATE BASI_030 r
SET
  r.RESPONSAVEL = r.OBSERVACAO3
;
...
SELECT
  SUBSTR(c.DESCRICAO_15, 10, 99) d
, c.*
FROM basi_010 c
WHERE c.DESCRICAO_15 like '%COMBINA. %'
;

UPDATE basi_010 c
SET
   c.DESCRICAO_15 = SUBSTR(c.DESCRICAO_15, 10, 99)
WHERE c.DESCRICAO_15 like '%COMBINA. %'
;

SELECT
  SUBSTR(c.DESCRICAO_15, 9, 99) d
, c.*
FROM basi_010 c
WHERE c.DESCRICAO_15 like '%COMBINA.%'
;
...
UPDATE basi_010 c
SET
   c.DESCRICAO_15 = SUBSTR(c.DESCRICAO_15, 9, 99)
WHERE c.DESCRICAO_15 like '%COMBINA.%'
;
